...
from src.muzero import diagnose_model
from src.muzero import models
from src.muzero import replay_buffer
from src.muzero import self_play
from src.muzero import shared_storage
from src.muzero import trainer
...
class MuZero:
    ...
    def __init__(self, game_name, config=None, split_resources_in=1):
        ...
        try:
            game_module = importlib.import_module("src.muzero.games." + game_name)
